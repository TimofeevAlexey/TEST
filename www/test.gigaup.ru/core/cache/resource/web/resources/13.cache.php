<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1414009127,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1414009127,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Товар 2 - MODX Revolution</title>
	...
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li class="first"><a href="index.php?id=1" >Главная</a></li><li><a href="index.php?id=4" >Регистрация</a></li><li><a href="index.php?id=6" >Авторизация</a></li>
					<li class=" dropdown">
					...
					<li class="last active dropdown">
						...
						<ul class="dropdown-menu"><li class="first"><a href="index.php?id=12" >Товар 1</a></li><li class="last active"><a href="index.php?id=13" >Товар 2</a></li></ul>
					</li>
			</ul>
		</div><!--/.nav-collapse -->
	</div>
		...
		<div class="container">
			<ol class="breadcrumb"><li><a href="index.php?id=1">Главная</a></li><li><a href="index.php?id=11">Каталог</a></li><li class="active">Товар 2</li></ol>
...
',
  ...
  array (
    '[[*pagetitle]]' => 'Товар 2',
    '[[*longtitle:default=`Товар 2`]]' => 'Товар 2',
    '[[MinifyX?
	&minifyCss=`1`
	&registerCss=`1`
	&cssSources=`
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    ...
    '[[$Crumbs]]' => '<ol class="breadcrumb"><li><a href="index.php?id=1">Главная</a></li><li><a href="index.php?id=11">Каталог</a></li><li class="active">Товар 2</li></ol>',
    '[[$Content.inner]]' => '<h3>Товар 2</h3>
