<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1414008870,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1414008870,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
	<div class="container">
		...
		<div class="container">
			<ol class="breadcrumb"><li><a href="index.php?id=1">Главная</a></li><li class="active">Каталог</li></ol>
...
',
  ...
  array (
    '[[*pagetitle]]' => 'Каталог',
    '[[*longtitle:default=`Каталог`]]' => 'Каталог',
    '[[MinifyX?
	&minifyCss=`1`
	&registerCss=`1`
	&cssSources=`
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    ...
    '[[$Crumbs]]' => '<ol class="breadcrumb"><li><a href="index.php?id=1">Главная</a></li><li class="active">Каталог</li></ol>',
    '[[$Content.inner]]' => '<h3>Каталог</h3>
